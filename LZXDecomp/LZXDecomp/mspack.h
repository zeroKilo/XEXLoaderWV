...
struct mspack_system {
   ...
   */
  struct mspack_file * (*open)(struct mspack_system *dis, char *filename, int mode);
   ...
   * @see free()
   */
  void * (*alloc)(struct mspack_system *dis,
		  size_t bytes);
 ...
 */
extern void mspack_destroy_cab_compressor(struct mscab_compressor *dis);

/** Destroys an existing CAB decompressor.
 * @param this the #mscab_decompressor to destroy
 */
extern void mspack_destroy_cab_decompressor(struct mscab_decompressor *dis);
 ...
 */
extern void mspack_destroy_chm_compressor(struct mschm_compressor *dis);

/** Destroys an existing CHM decompressor.
 * @param this the #mschm_decompressor to destroy
 */
extern void mspack_destroy_chm_decompressor(struct mschm_decompressor *dis);
 ...
 */
extern void mspack_destroy_lit_compressor(struct mslit_compressor *dis);

/** Destroys an existing LIT decompressor.
 * @param this the #mslit_decompressor to destroy
 */
extern void mspack_destroy_lit_decompressor(struct mslit_decompressor *dis);
 ...
 */
extern void mspack_destroy_hlp_compressor(struct mshlp_compressor *dis);

/** Destroys an existing hlp decompressor.
 * @param this the #mshlp_decompressor to destroy
 */
extern void mspack_destroy_hlp_decompressor(struct mshlp_decompressor *dis);
 ...
 */
extern void mspack_destroy_szdd_compressor(struct msszdd_compressor *dis);

/** Destroys an existing SZDD decompressor.
 * @param this the #msszdd_decompressor to destroy
 */
extern void mspack_destroy_szdd_decompressor(struct msszdd_decompressor *dis);
 ...
 */
extern void mspack_destroy_kwaj_compressor(struct mskwaj_compressor *dis);

/** Destroys an existing KWAJ decompressor.
 * @param this the #mskwaj_decompressor to destroy
 */
extern void mspack_destroy_kwaj_decompressor(struct mskwaj_decompressor *dis);
...
struct mscab_decompressor {
   ...
   */
  struct mscabd_cabinet * (*open) (struct mscab_decompressor *dis,
				   char *filename);
   ...
   */
  void (*close)(struct mscab_decompressor *dis,
   ...
   */
  struct mscabd_cabinet * (*search) (struct mscab_decompressor *dis,
				     char *filename);
   ...
   */
  int (*append) (struct mscab_decompressor *dis,
		 struct mscabd_cabinet *cab,
		 struct mscabd_cabinet *nextcab);
   ...
   */
  int (*prepend) (struct mscab_decompressor *dis,
		  struct mscabd_cabinet *cab,
		  struct mscabd_cabinet *prevcab);
   ...
   * @return an error code, or MSPACK_ERR_OK if successful
   */
  int (*extract)(struct mscab_decompressor *dis,
   ...
   * @see search(), extract()
   */
  int (*set_param)(struct mscab_decompressor *dis,
		   int param,
		   int value);
...
struct mschm_decompressor {
   ...
   * @see close()
   */
  struct mschmd_header *(*open)(struct mschm_decompressor *dis,
				char *filename);
   ...
   * @see open(), fast_open()
   */
  void (*close)(struct mschm_decompressor *dis,
		struct mschmd_header *chm);
   ...
   * @return an error code, or MSPACK_ERR_OK if successful
   */
  int (*extract)(struct mschm_decompressor *dis,
   ...
   * @see open(), search()
   */
  int (*last_error)(struct mschm_decompressor *dis);
   ...
   */
  struct mschmd_header *(*fast_open)(struct mschm_decompressor *dis,
				     char *filename);
   ...
   * @see open(), close(), fast_find(), extract()
   */
  int (*fast_find)(struct mschm_decompressor *dis,
		   struct mschmd_header *chm,
		   char *filename,
